    ...
    <div class="container">
        ...
        <div class="product-nav-collapse">
            <ul class="nav-product d-flex list-unstyled flex-column justify-content-center text-center flex-sm-row justify-content-sm-end my-2">
                ...
                <li class="nav-item"><a class="nav-link py-1" href="{{ route('product.overview', 'magus-2in1') }}">@lang('cosmos.name')</a></li>
                <li class="nav-item"><a class="nav-link py-1" href="{{ route('product.overview', 'magus-2in1-spec') }}">@lang('site.productnav_spec')</a></li>
